...
class LearningAgent(Agent):
    ...
    def build_state(self):
        ...
        # State string
        state = stringHelper(waypoint) + ' ' + inputs['light'] + ' ' + stringHelper(inputs['left']) + ' ' + stringHelper(inputs['oncoming'])
        # Handle Q dict
        if self.learning:
    ...
    def choose_action(self, state):
        ...
        if not self.learning:
            ...
            if self.epsilon > random.random() and self.epsilon > 0.01:
                ...
                action = random.choice(temp_acts)
        return action
    ...
    def learn(self, state, action, reward):
        ...
        if self.learning:
            self.Q[state][action] = temp * (1 - self.alpha) + self.alpha * reward
        return
